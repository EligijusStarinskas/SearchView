...
public class ToolbarActivity extends BaseActivity implements View.OnClickListener {
    ...
    private int mVersion = SearchCodes.VERSION_TOOLBAR_MIXED;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_delete:
                Snackbar.make(view, "Search history deleted", Snackbar.LENGTH_LONG)
            ...
            case R.id.button_classic:
                ...
                intent.putExtra("version", SearchCodes.VERSION_MENU_ITEM_FLOATING);
